...
class BurgerScreen extends StatefulWidget {
  Burgers burgers;
  BurgerScreen({required this.burgers});
          ...
          children: [
            Stack(
              children: [
                Center(
                  child: Image(
                    image: AssetImage(widget.burgers.imageUrlb),
                    width: 270,
                    height: 270,
                  ),
                ),
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Center(
                      child: Text(widget.burgers.name,
                  ...
                  Padding(
                    ...
                    child: Text(widget.burgers.ingredients,
